...
/******/ 	var hotCurrentHash = "0ae6bcd165b6fdab5ab6"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var expressApp = (0, _express2.default)(),
	    server = _http2.default.createServer(expressApp),
	    io = (0, _socket2.default)(server),
	    sockets = [];
	
	expressApp.use(_express2.default.static(_path2.default.join(__dirname, '../frontend')));
	...
	server.listen(4000);
	/* WEBPACK VAR INJECTION */}.call(exports, "backend"))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _visibilityFilter = __webpack_require__(22);
...
/***/ function(module, exports) {
	...
	var todo = function todo(state, action, index) {
	  switch (action.type) {
	    case 'ADD_TODO':
	      return {
	        text: action.text,
...
/***/ function(module, exports) {
	...
	function onAction(store, socket, action) {
	  var serverAction = _extends({}, action, { fromServer: true });
	...
	function onConnection(store, socket) {
